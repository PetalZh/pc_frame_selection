...
class CounterHeadKittiExp(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        if not self.training or self.predict_boxes_when_training:
            ...
            for i in range(pred_dicts_list[0].size(-1)):
                ...
                # file = '/data/kitti_hm_partition9/{}.txt'.format(self.progress)
            ...
            #     cls_preds=cls_pred_list[0], box_preds=box_preds, dir_cls_preds=None
            # )
    ...
    def assign_targets(self, ranges, gt_boxes):
        ...
        # # heatmaps = torch.stack([torch.stack(sublist) for sublist in heatmaps])
        # print('aaaaaaaaaaa')

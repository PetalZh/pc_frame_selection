...
class CenterHead(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # file = '/data/feature_waymo_train/{}.txt'.format(data_dict['frame_id'][0])
        # with open(file, 'w') as f: 
        #     json.dump(spatial_features_2d.mean(dim=1, keepdim=True).tolist(), f)
        ...
        if not self.training or self.predict_boxes_when_training:
            ...
            # file = '/data/waymo_heatmap/{}.txt'.format(data_dict['frame_id'][0])
            # with open(file, 'w') as f: 
            #     json.dump(heatmap_list, f)

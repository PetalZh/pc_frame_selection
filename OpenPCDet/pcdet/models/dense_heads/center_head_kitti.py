...
class CenterHeadKitti(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        if not self.training or self.predict_boxes_when_training:
            ...
            # extra code for saving the heatmap
            ...
            for i in range(pred_dicts.size(-1)):
                ...
                heatmap_list.append(pred_heatmap.squeeze(0).tolist())

            # file = '/data/kitti_heatmap/{}.txt'.format(data_dict['frame_id'][0])

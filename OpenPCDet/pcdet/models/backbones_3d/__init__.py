...
from .counter_prompt import VoxelNetWithPrompt
from .counter_prompt import VoxelNetWithAdaptor
...
__all__ = {
    ...
    'DSVT': DSVT,
    'VoxelNetWithPrompt': VoxelNetWithPrompt,
    'VoxelNetWithAdaptor': VoxelNetWithAdaptor,
    'HEDNet': HEDNet,
    'HEDNet2D': HEDNet2D,
